...
class ApiRequests:
    ...
    def get_failed_tests_defects_list(self, failed_tests_ids_list: list[int]) -> list[TestInRunResults]:
        ...
        if not self.__tests_with_defects_list:
            for test_id in failed_tests_ids_list:
                ...
                print("Request to get results of failed tests was sent")
    ...
    def get_tests_in_run(self, run_id: int) -> list[TestInRun]:
        ...
        print("Request to get tests in run was sent")
    ...
    def get_test_results_from_all_test_runs(self) -> Union[list[TestInRun], list[Any]]:
        ...
        if not self.__list_with_all_tests_results:
            ...
            self.__list_with_all_tests_results = list(itertools.chain.from_iterable(list_with_test_runs_results_lists))
            write_list_of_dicts_to_file(cached_file_name,
                                        [test_result.full_info for test_result in self.__list_with_all_tests_results])
    ...
    def __get_runs(self) -> list[TestRun]:
        ...
        if not test_runs_list:
            ...
            print("Request to get runs was sent and received")
